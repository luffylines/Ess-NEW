<x-app-layout>
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h2 fw-bold">Edit Work Schedule</h1>
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-warning text-dark">
                <h5 class="mb-0">
                    <i class="fas fa-edit me-2"></i>Edit Schedule for {{ $schedule->employee->name }}
                </h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="shift_type" id="shift_type" class="form-select" required>
                                <option value="regular" {{ old('shift_type', $schedule->shift_type) == 'regular' ? 'selected' : '' }}>Regular</option>
                                <option value="overtime" {{ old('shift_type', $schedule->shift_type) == 'overtime' ? 'selected' : '' }}>Overtime</option>
                                <option value="holiday" {{ old('shift_type', $schedule->shift_type) == 'holiday' ? 'selected' : '' }}>Holiday</option>
                            </select>
                            @error('shift_type')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="notes" id="notes" class="form-control" rows="3" 
                                      placeholder="Additional instructions, special requirements, or notes for this schedule">{{ old('notes', $schedule->notes) }}</textarea>
                            @error('notes')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="alert alert-info">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div id="working-hours-display" class="fw-bold text-primary">{{ $schedule->getWorkingHours() }} hours</div>
                                    </div>
                                </div>
                            </div>
                        </div>
