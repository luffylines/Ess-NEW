<aside class="main-sidebar pob-sidebar" id="sidebar">
    <div class="brand-container">
        <div class="menu-text sidebar-menu-copy">
            <span class="sidebar-menu-kicker">Workspace</span>
            <strong>Navigation</strong>
        </div>
        <button id="sidebarToggle" type="button" class="sidebar-toggle" aria-label="Toggle sidebar" title="Open menu">
...
<style>
.pob-sidebar{width:72px;height:100vh;position:fixed;inset:0 auto 0 0;z-index:1045;display:flex;flex-direction:column;background:rgba(255,255,255,.9)!important;border-right:1px solid var(--pob-line)!important;backdrop-filter:blur(20px) saturate(150%);box-shadow:8px 0 30px rgba(45,34,42,.04);overflow:hidden;transition:width .3s cubic-bezier(.2,.7,.2,1),left .3s ease}.pob-sidebar.expanded{width:270px}.pob-sidebar:not(.expanded) .menu-text{display:none!important}.brand-container{height:72px;padding:12px 14px;border-bottom:1px solid var(--pob-line);display:flex;align-items:center;justify-content:center;gap:10px}.pob-sidebar.expanded .brand-container{justify-content:space-between}.sidebar-menu-copy{line-height:1.05;min-width:150px}.sidebar-menu-copy strong{display:block;font-size:.9rem;letter-spacing:-.02em}.sidebar-menu-kicker{display:block;color:var(--pob-muted);font-size:.6rem;font-weight:800;letter-spacing:.12em;text-transform:uppercase;margin-bottom:4px}.sidebar-toggle{width:42px;height:42px;flex:0 0 42px;border:1px solid rgba(198,79,122,.16);background:linear-gradient(135deg,rgba(198,79,122,.10),rgba(127,103,179,.08));color:var(--pob-rose-deep);border-radius:14px;display:grid;place-items:center;font-size:1.05rem;box-shadow:0 7px 20px rgba(60,40,50,.06);transition:transform .2s ease,box-shadow .2s ease,background .2s ease}.sidebar-toggle:hover{transform:translateY(-1px);box-shadow:0 10px 24px rgba(60,40,50,.10);background:linear-gradient(135deg,rgba(198,79,122,.16),rgba(127,103,179,.12))}.pob-sidebar.expanded .sidebar-toggle i{transform:rotate(180deg)}.sidebar-toggle i{transition:transform .25s ease}.user-panel{margin:14px 10px;padding:9px;display:flex;align-items:center;gap:10px;border:1px solid var(--pob-line);border-radius:18px;background:rgba(198,79,122,.045);position:relative;min-height:58px}.pob-sidebar:not(.expanded) .user-panel{justify-content:center;margin:14px 8px;padding:7px}.profile-pic{width:42px;height:42px;border-radius:14px;object-fit:cover;object-position:center 18%;border:2px solid rgba(198,79,122,.20);background:#fff;box-shadow:0 6px 16px rgba(45,31,40,.08);flex:none;display:block}.pob-sidebar:not(.expanded) .profile-pic{margin:0 auto}.user-copy{min-width:0;line-height:1.15}.user-copy strong{display:block;font-size:.82rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.user-copy span{display:block;font-size:.68rem;color:var(--pob-muted);margin-top:4px}.online-dot{width:8px;height:8px;border-radius:50%;background:#43a77f;margin-left:auto;box-shadow:0 0 0 4px rgba(67,167,127,.12)}.sidebar{overflow-y:auto;padding:0 8px 16px}.pob-nav{gap:3px}.nav-section-label{padding:14px 10px 5px;color:var(--pob-muted);font-size:.64rem;font-weight:800;letter-spacing:.11em;text-transform:uppercase}.pob-sidebar .nav-link{height:auto;min-height:46px;padding:10px 12px;border-radius:14px;color:var(--pob-muted)!important;display:flex;align-items:center;gap:10px;font-size:.82rem;font-weight:700;transition:background .2s ease,color .2s ease,transform .2s ease}.pob-sidebar:not(.expanded) .nav-link{justify-content:center;padding:10px 8px}.pob-sidebar .nav-link:hover{background:rgba(198,79,122,.08);color:var(--pob-text)!important}.pob-sidebar.expanded .nav-link:hover{transform:translateX(2px)}.pob-sidebar .nav-link.active{background:linear-gradient(135deg,rgba(198,79,122,.16),rgba(127,103,179,.11));color:var(--pob-rose-deep)!important}.nav-icon{width:28px;min-width:28px;text-align:center;font-size:1rem}.sidebar-submenu{margin:3px 0 6px 22px;padding-left:10px;border-left:1px solid var(--pob-line);display:none}.sidebar-submenu.open{display:flex}.sidebar-submenu .nav-link{min-height:36px;padding:7px 10px;font-size:.74rem}.submenu-chevron{transition:transform .2s ease}.sidebar-submenu-toggle.open .submenu-chevron{transform:rotate(180deg)}.sidebar-footer{padding:12px;border-top:1px solid var(--pob-line)}.sidebar-logout{width:100%;border:1px solid rgba(181,72,85,.16);border-radius:14px;padding:10px 12px;background:rgba(181,72,85,.07);color:var(--pob-danger);display:flex;align-items:center;justify-content:center;gap:8px;font-weight:800}.dark .pob-sidebar{background:rgba(29,24,29,.92)!important}.pob-sidebar::-webkit-scrollbar,.sidebar::-webkit-scrollbar{width:4px}.pob-sidebar::-webkit-scrollbar-thumb,.sidebar::-webkit-scrollbar-thumb{background:rgba(198,79,122,.25);border-radius:20px}@media(max-width:992px){.pob-sidebar{left:-290px;width:280px!important;box-shadow:18px 0 50px rgba(0,0,0,.18)}.pob-sidebar.mobile-active{left:0}.pob-sidebar.mobile-active .menu-text{display:block!important}.pob-sidebar.mobile-active .brand-container{justify-content:space-between}.pob-sidebar.mobile-active .user-panel{justify-content:flex-start;margin:14px 10px;padding:9px}.pob-sidebar.mobile-active .profile-pic{margin:0}.pob-sidebar.mobile-active .nav-link{font-size:.9rem;justify-content:flex-start;padding:10px 12px}.pob-sidebar.mobile-active .sidebar-submenu{display:none}.pob-sidebar.mobile-active .sidebar-submenu.open{display:flex}}
</style>
...
document.addEventListener('DOMContentLoaded',function(){
    ...
    toggle?.addEventListener('click',function(){
        if(window.innerWidth<=992){
            ...
            this.title=sidebar.classList.contains('expanded')?'Close menu':'Open menu';
        }
    });

    document.querySelectorAll('.sidebar-submenu-toggle').forEach(function(button){
        button.addEventListener('click',function(){
            const menu=document.getElementById(this.dataset.submenuTarget);
    ...
    document.addEventListener('click',function(event){
        if(window.innerWidth<=992&&sidebar.classList.contains('mobile-active')&&!sidebar.contains(event.target)&&!event.target.closest('.mobile-menu-toggle')){
